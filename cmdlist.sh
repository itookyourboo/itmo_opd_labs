...
#5
rm -f grotle1
rm -f ~/lab0/feebas3/starmie
rm -f Copy_*
rm -f ~/lab0/nidorino1/venonatremoraid
rm -rf nidorino1
# rm: cannot read directory nidorino1: Permission denied
# EDIT: chmod u+r nidorino1/
rm -r ~/lab0/feebas3/swadloon

# .:
# total 15
# drwx--x--x   4 s311725  studs          5 сент. 28 12:35 feebas3
# -rw-r--r--   1 s311725  studs        236 сент. 28 12:34 grotle1_31
# -rw--w--w-   1 s311725  studs         94 сент. 28 12:33 pelipper7
# -r--rw----   1 s311725  studs        100 сент. 28 12:33 remoraid2
# d-wxrwx-wx   3 s311725  studs          6 сент. 28 12:34 reuniclus5
# drwxr-xr-x   2 s311725  studs          3 сент. 28 12:36 tmp
# 
# ./feebas3:
# total 7
# dr-x--x--x   2 s311725  studs          2 сент. 28 12:33 electabuzz
# dr-x--x-wx   2 s311725  studs          2 сент. 28 12:33 mothim
# lrwxrwxrwx   1 s311725  studs         26 сент. 28 12:34 starmiegrotle -> /home/s311725/lab0/grotle1
# 
# ./feebas3/electabuzz:
# total 0
# 
...
# ./tmp:
# total 1
# -rw-r--r--   1 s311725  studs          0 сент. 28 12:36 file